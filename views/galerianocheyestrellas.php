        ...
        <div id="main">
          ...
          <section class="photo-gallery animatedParent" id='photos'>
            <div class="row text-center">
              <h1 class="phototitle">NOCHE Y ESTRELLAS</h1>
              <h3 class="phototitle">Un subtitulo tu que escribes bien iría bien aqui</h3>
            </div>
              <div class="row">
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-250" src="/img/fulls/nocheyestrellas01.jpg" alt="montaña" onclick="ver(this);"/>
              </div>
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-500" src="/img/fulls/nocheyestrellas02.jpg" alt="Mrs Stranger" onclick="ver(this);"/>
              </div>
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-1000"src="/img/fulls/nocheyestrellas03.jpg" alt="Mrs Stranger" onclick="ver(this);"/>
                </div>
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-1500" src="/img/fulls/nocheyestrellas04.jpg" alt="Mrs Stranger" onclick="ver(this);"/>
              </div>
              </div>
            </section>
            <!-- COOKIES -->
