            ...
            <div class="row text-center">
              ...
              <div class="row">
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-250" src="/img/fulls/montaña01.jpg" alt="montaña" onclick="ver(this);"/>
                  <img class="animated bounceIn delay-1500" src="/img/fulls/montaña05.jpg" alt="This Is Irma"onclick="ver(this);"/>
                </div>
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-500" src="/img/fulls/montaña02.jpg" alt="Mrs Stranger" onclick="ver(this);"/>
                  <img class="animated bounceIn delay-1000" src="/img/fulls/montaña06.jpg" alt="People. Chaos. City" onclick="ver(this);"/>
                </div>
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-1000"src="/img/fulls/montaña03.jpg" alt="Mrs Stranger" onclick="ver(this);"/>
                  <img class="animated bounceIn delay-250" src="/img/fulls/montaña07.jpg" alt="People. Chaos. City" onclick="ver(this);"/>
                </div>
                <div class="column animatedParent">
                  <img class="animated bounceIn delay-1500" src="/img/fulls/montaña04.jpg" alt="Mrs Stranger" onclick="ver(this);"/>
                  <img class="animated bounceIn delay-500" src="/img/fulls/montaña08.jpg" alt="People. Chaos. City" onclick="ver(this);"/>
                </div>
              </div>
            </section>
            <!-- COOKIES -->
